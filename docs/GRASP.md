...
> **หมายเหตุ "ปลาย gripper ทะลุพื้น"**: ตอน descend ปลาย jaw แตะพื้น (z≈0.001)
> ดูเหมือนทะลุในมุมข้าง แต่ไม่ได้ทะลุจริง — เป็นเพราะ SO-101 คีบด้วย **ปลาย jaw**
> เวลาหยิบของที่พื้น jaw จึงต้องลงไปใกล้พื้น (top-down grasp + collision filter §3).
>
> **ทางเลือกที่พิจารณาแล้ว (เลือกคง top-down):**
> - *ยกวัตถุขึ้น platform*: gripper จะคีบที่ระดับสูงขึ้น ปลายไม่เฉียดพื้น — แต่เคย
>   ลองแล้ว platform ทำให้ shoulder ชนขอบ (§3) ต้อง rework scene เยอะ
> - *side grasp (jaw แนวนอน)*: หมุน wrist ให้ jaw ขนานพื้น คีบด้านข้างลูก — แต่
>   IK/FSM ซับซ้อนกว่า และ SO-101 workspace ทำท่านี้กับลูกที่พื้นได้ยาก
> - **คงเดิม (top-down)**: physics ถูกต้อง (ปลายเฉียดพื้นไม่ทะลุ), dataset ใช้ได้
>   (VLA เรียนจากภาพ+action ที่สมเหตุผล), success 100%. ✅ เลือกอันนี้
>
> ถ้าอยากลดการเฉียดพื้น ปรับ `grasp_z_offset` สูงขึ้นได้ (แลกกับ jaw คร่อมตื้นลง).
