...
### 8.3 คีบด้วย "ปลายนิ้ว" — ปลายไม่ทะลุพื้น

**อาการ**: ปลายนิ้วทะลุพื้นลึก **67mm** ตอนหยิบวัตถุที่พื้น (ดูไม่จริง).

**ต้นตอ**: pinch เดิม = "จุดหนีบกลางนิ้ว" — แต่ **ปลายนิ้วยื่นเลยจุดหนีบลงไปอีก
82mm**. พอเอาจุดหนีบ (กลาง) ไปที่ลูก center (z=11mm) ปลายนิ้วเลยมุดลงใต้พื้น 67mm.

**แก้ (แนวคิดผู้ใช้ "หยิบด้วยปลาย")**: ย้าย pinch site จากกลางนิ้ว → **ปลายนิ้วสุด**
(`pos="0.0201 0 -0.1027"`, z ต่ำสุดของ mesh นิ้ว). พอ IK เอา *ปลายนิ้ว* ไปที่ลูก
→ ปลายหยุดที่ผิววัตถุ (z=11mm) **ไม่เลยลงใต้พื้น**. re-calibrate `_GRASP_REF_QPOS`.

ผล: **ปลายนิ้วต่ำสุด 12mm เหนือพื้น (ไม่ทะลุ)** จากเดิม -67mm. success ยัง 100%.
grasp-assist weld ช่วยให้คีบด้วยปลายมั่นคง (ปลายจิกลูก + weld ตรึง).

> หลักการ: จุดที่ IK เล็ง (pinch) ควรเป็น **จุดที่ยื่นต่ำสุด/ไกลสุดของ end-effector**
> เมื่อเข้าหาวัตถุที่พื้น — ไม่งั้นส่วนที่ยื่นเลยจะทะลุพื้น.
